...
public class Printing {
    public static void print1() {
        ...
        System.out.println("Il randomArrayAscending(): " + Arrays.toString(random_ascending_array));
        System.out.println("Il randomArrayDescending(): " + Arrays.toString(random_descending_array));
        System.out.println("#########################################################################################");
